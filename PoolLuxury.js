...
(function () {
  ...
  function initPreloader() {
    ...
    var maxWait = prefersReducedMotion ? 200 : 5000;
    ...
    // Ждём полную загрузку всех ресурсов страницы (картинки, шрифты, стили и т.д.)
    ...
    Promise.all([waitForWindowLoad(), waitForAllImages()]).then(finish);

    // Страховка: если что-то зависло (например, битая ссылка на ресурс,
    // которую браузер не считает завершённой), не блокируем сайт вечно.
